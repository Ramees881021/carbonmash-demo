...
const navItems: NavItem[] = [{
  ...
  icon: Calculator,
  subItems: [{
    id: 'carbon-calculator-database',
    label: 'Database',
    icon: Database
  }, {
    id: 'carbon-calculator-audit-trail',
    label: 'Audit Trail',
    icon: History
  }, {
    id: 'carbon-calculator-dashboard',
    label: 'Dashboard',
    icon: PieChart
  }]
}, {
...
export const Sidebar = ({
  ...
  return <aside className="w-64 bg-sidebar text-sidebar-foreground flex flex-col fixed top-0 left-0 h-screen z-10">
      ...
      <div className="p-6 border-b border-sidebar-border">
        <div className="flex items-baseline gap-1.5 font-wordmark tracking-tight">
          <span className="text-xl text-sidebar-foreground">Net-Z</span>
          <span className="text-xl text-sidebar-primary">Platform</span>
        </div>
      </div>
