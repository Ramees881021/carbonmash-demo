...
// Materials that products are made of — DEFRA 2026 factors (tCO₂e per tonne)
...
const EOL_FACTORS: Record<string, Record<string, number>> = {
  plastics:          { landfill: 0.00901, recycling: 0.00465, incineration: 0.00465, incineration_no_er: 0.00465, composting: 0, anaerobic: 0 },
  metals_ferrous:    { landfill: 0.00901, recycling: 0.00465, incineration: 0.00465, incineration_no_er: 0.00465, composting: 0, anaerobic: 0 },
  metals_aluminium:  { landfill: 0.00901, recycling: 0.00465, incineration: 0.00465, incineration_no_er: 0.00465, composting: 0, anaerobic: 0 },
  glass:             { landfill: 0.00901, recycling: 0.00465, incineration: 0.00465, incineration_no_er: 0.00465, composting: 0, anaerobic: 0 },
  paper_cardboard:   { landfill: 1.16451, recycling: 0.00465, incineration: 0.00465, incineration_no_er: 0.00465, composting: 0.00901, anaerobic: 0.00901 },
  wood:              { landfill: 0.92537, recycling: 0.00465, incineration: 0.00465, incineration_no_er: 0.00465, composting: 0.00901, anaerobic: 0.00901 },
  textiles:          { landfill: 0.49681, recycling: 0.00465, incineration: 0.00465, incineration_no_er: 0.00465, composting: 0, anaerobic: 0 },
  electronics_weee:  { landfill: 0.00901, recycling: 0.00465, incineration: 0.00465, incineration_no_er: 0.00465, composting: 0, anaerobic: 0 },
  rubber:            { landfill: 0.00901, recycling: 0.00465, incineration: 0.00465, incineration_no_er: 0.00465, composting: 0, anaerobic: 0 },
  concrete:          { landfill: 0.00901, recycling: 0.00101, incineration: 0.00465, incineration_no_er: 0.00465, composting: 0, anaerobic: 0 },
  mixed_municipal:   { landfill: 0.52058, recycling: 0.00465, incineration: 0.00465, incineration_no_er: 0.52058, composting: 0.00901, anaerobic: 0.00901 },
};
...
export const EndOfLifeForm = ({ onAdd, onAddBatch, sites = [], entries = [] }: EndOfLifeFormProps) => {
  ...
  const handleTemplate = () => {
    ...
    XLSX.utils.book_append_sheet(wb, fSheet, 'REF - Factors (DEFRA 2026)');
