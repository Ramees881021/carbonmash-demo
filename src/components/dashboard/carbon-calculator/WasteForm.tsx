...
// DEFRA 2026 waste factors — material × treatment (tCO₂e per tonne)
...
// DEFRA 2026 material×treatment factors (tCO₂e per tonne)
// Where DESNZ publishes no factor for a material/treatment pair, the generic waste value for that treatment is used.
const WASTE_FACTORS_MATRIX: Record<string, Record<string, number>> = {
  mixed_municipal:    { landfill: 0.52058, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.52058 },
  paper_cardboard:    { landfill: 1.16451, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  plastics:           { landfill: 0.00901, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  metals_ferrous:     { landfill: 0.00901, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  metals_non_ferrous: { landfill: 0.00901, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  glass:              { landfill: 0.00901, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  food_drink:         { landfill: 0.70033, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  garden_organic:     { landfill: 0.64673, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  wood:               { landfill: 0.92537, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  textiles:           { landfill: 0.49681, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  electrical_weee:    { landfill: 0.00901, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  construction:       { landfill: 0.00901, recycling: 0.00101, closed_loop: 0.00101, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
  tyres:              { landfill: 0.00901, recycling: 0.00465, closed_loop: 0.00465, composting: 0.00901, anaerobic: 0.00901, incineration: 0.00465, incineration_no_er: 0.00465 },
};
...
const AVERAGE_TREATMENT_FACTORS: Record<string, { label: string; factor: number }> = {
  landfill:           { label: 'Landfill', factor: 0.52058 },
  recycling:          { label: 'Recycling', factor: 0.00465 },
  composting:         { label: 'Composting', factor: 0.00901 },
  anaerobic:          { label: 'Anaerobic Digestion', factor: 0.00901 },
  incineration:       { label: 'Incineration (Energy Recovery)', factor: 0.00465 },
  incineration_no_er: { label: 'Incineration (No Recovery)', factor: 0.52058 },
};
                  ...
                  <div className="space-y-3">
                    ...
                    {isActive && wasteTypeFactor !== null && wasteTonnes && parseFloat(wasteTonnes) > 0 && (
                      <div className="p-2 rounded bg-muted/50 text-xs text-muted-foreground">
                        ...
                        <span className="ml-2 text-[10px]">(DEFRA 2026)</span>
                      </div>
                    )}
                  </div>
                )}
                  ...
                  <div className="space-y-3">
                    ...
                    {isActive && avgTotalWeight && avgFactor !== null && parseFloat(avgTotalWeight) > 0 && (
                      <div className="p-2 rounded bg-muted/50 text-xs text-muted-foreground">
                        ...
                        <span className="ml-2 text-[10px]">(DEFRA 2026 avg)</span>
                      </div>
                    )}
                  </div>
                )}
