...
// Freight transport emission factors (tCO₂e per tonne.km) — DEFRA 2026
const FREIGHT_MODES = {
  road_hgv_avg: { label: 'Road – HGV (all, avg laden)', factor: 0.00010356, unit: 'tonne.km', source: 'DEFRA 2026' },
  road_hgv_rigid: { label: 'Road – HGV Rigid', factor: 0.00019947, unit: 'tonne.km', source: 'DEFRA 2026' },
  road_hgv_artic: { label: 'Road – HGV Articulated', factor: 0.00007926, unit: 'tonne.km', source: 'DEFRA 2026' },
  road_van: { label: 'Road – Van', factor: 0.00063511, unit: 'tonne.km', source: 'DEFRA 2026' },
  rail_freight: { label: 'Rail Freight', factor: 0.00002583, unit: 'tonne.km', source: 'DEFRA 2026' },
  sea_container: { label: 'Sea – Container Ship', factor: 0.00001612, unit: 'tonne.km', source: 'DEFRA 2026' },
  sea_bulk: { label: 'Sea – Bulk Carrier', factor: 0.00000353, unit: 'tonne.km', source: 'DEFRA 2026' },
  sea_tanker: { label: 'Sea – Tanker', factor: 0.00000457, unit: 'tonne.km', source: 'DEFRA 2026' },
  sea_ro_ro: { label: 'Sea – Ro-Ro Ferry', factor: 0.00005158, unit: 'tonne.km', source: 'DEFRA 2026' },
  air_domestic: { label: 'Air Freight – Domestic', factor: 0.00460397, unit: 'tonne.km', source: 'DEFRA 2026 (with RF)' },
  air_short_haul: { label: 'Air Freight – Short-Haul', factor: 0.00127835, unit: 'tonne.km', source: 'DEFRA 2026 (with RF)' },
  air_long_haul: { label: 'Air Freight – Long-Haul', factor: 0.00089939, unit: 'tonne.km', source: 'DEFRA 2026 (with RF)' },
  courier_parcel: { label: 'Courier / Parcel Delivery', factor: 0.00063511, unit: 'tonne.km', source: 'DEFRA 2026 (van avg proxy)' },
} as const;
      ...
      {method === 'activity' && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Weight × Distance × Mode-specific emission factor (tCO₂e per tonne.km, DEFRA 2026)
            </CardDescription>
          </CardHeader>
