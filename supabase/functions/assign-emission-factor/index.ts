...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an expert carbon emissions analyst specializing in GHG Protocol Scope 3 emissions accounting. Your job is to assign accurate emission factors based on DEFRA 2026, IEA 2025, and EPA standards.
...
- Use DEFRA 2026 emission factors as primary reference
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          emission_factor_source: {
                            type: "string",
                            description:
                              "Source reference, e.g. 'DEFRA 2026 - Manufacturing' or 'EPA - Office supplies'",
                          },
                          reasoning: {
                            type: "string",
                            description:
