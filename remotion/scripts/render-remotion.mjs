...
await renderMedia({ composition, serveUrl: bundled, codec: "h264", outputLocation: process.argv[2] ?? "/tmp/out.mp4", puppeteerInstance: browser, muted: true, concurrency: 4 });
